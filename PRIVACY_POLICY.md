# Privacy Policy — Save As Image Type
...
1. The image is drawn to an in-memory HTML Canvas element
2. The canvas converts the image to your chosen format
3. The browser's built-in download dialog opens for you to save the file
